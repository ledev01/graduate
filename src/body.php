...
<!-- Sản phẩm nổi bật -->
<h1 class="pl-64 text-3xl font-mono text-gray-700 underline mt-16">Sản phẩm giảm giảm giá</h1>
<div class="grid grid-cols-4 max-w-5xl mx-auto gap-x-12 gap-y-10 mt-4">
  ...
  foreach ($sphome3 as $sp) {
    ...
    echo '
    <form action="show.php?act=addcart" method="post" class="product-form">
