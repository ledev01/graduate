        ...
        <div> 
            ...
            if (isset($_SESSION['giohang']) && count($_SESSION['giohang']) > 0) { 
                ...
                foreach ($_SESSION['giohang'] as $item) { 
                    ...
                    echo '<tr> 
                        ...
                        <td class="border border-gray-300 px-4 py-2"> 
                            <a class="text-red-500 font-mono underline flex justify-center" href="show.php?act=del1cart&id=' . $item[0] . '">Xóa</a> 
                        </td> 
                    </tr>';
                    $i++; 
                }
                ...
                echo '<tr> 
                    ...
                    <td class="border border-gray-300 px-4 py-2"> 
                        <a href="show.php?act=delcart" class="w-auto h-auto bg-red-700 hover:bg-red-800 hover:scale-95 transition-transform duration-300 flex items-center justify-center px-1 rounded-md"> 
                ...
                <div class="flex flex-row">
                    ...
                    <div class="flex flex-row gap-x-4">
                        <div class="w-auto h-auto bg-custom-orange hover:bg-customhover-orange hover:scale-95 transition-transform duration-300 flex items-center justify-center px-2 rounded-md">
                            <a class="text-md text-white font-mono" href="show.php"> < Tiếp tục chọn sản phẩm</a>
                        </div>
                ...
                echo '<p class="text-xl text-red-500 font-mono mt-4">Giỏ hàng trống!</p>
                    <div class="flex flex-col gap-y-8">
                       ...
                       <div class="w-auto h-auto bg-custom-orange hover:bg-customhover-orange hover:scale-95 transition-transform duration-300 flex items-center justify-center px-2 rounded-md">
                            <a class="text-md text-white font-mono" href="show.php"> < Chọn sản phẩm nào !</a>
                        </div>
                    </div>
                '; 
            }
