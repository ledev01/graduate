...
<header class="w-full "> 
  ...
  <header class="bg-custom-orange h-28">
    ...
    if (isset($_SESSION['username']) && ($_SESSION['username'] != "")) {
      ...
      echo '<a href="show.php?act=userinfor">
      ...
      echo '<a href="show.php?act=thoat">
...
<div id="myElement" class="w-full z-20">
  <nav class="h-18 bg-custom-orange shadow sticky">
    ...
    <div class="hidden md:flex font-bold space-x-7">
        <a href="show.php" class="flex flex-row items-center gap-x-2">
    ...
    <div class="flex justify-center items-center mt-3">
      ...
      <div id="menu" class="hidden md:hidden">
          <div class="px-4 py-3">
              <a href="show.php" class="block text-white hover:text-yellow-200">Trang Chủ</a>
